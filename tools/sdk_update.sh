...
ONE_PLUGIN_SOURCE_PRIVATE_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_ENGINE_VERSION}/${ONE_PLUGIN_NAME}/Source/${ONE_PLUGIN_NAME}/Private/one/arcus
ONE_PLUGIN_SOURCE_PUBLIC_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_ENGINE_VERSION}/${ONE_PLUGIN_NAME}/Source/${ONE_PLUGIN_NAME}/Public/one/arcus
ONE_PLUGIN_SOURCE_THIRD_PARTY_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_ENGINE_VERSION}/${ONE_PLUGIN_NAME}/Source/ThirdParty/one/arcus/internal
