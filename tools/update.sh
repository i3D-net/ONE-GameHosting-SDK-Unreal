...
${ONE_PLUGIN_REPO_DIR}/tools/sdk_update_client_plugin.sh ${ONE_UNREAL_TEMPLATE} ${ONE_UNREAL_ENGINE_VERSION} ${ONE_SDK_REPO_DIR} ${ONE_PLUGIN_REPO_DIR} ${ONE_PLUGIN_VERSION}
${ONE_PLUGIN_REPO_DIR}/tools/sdk_update_server_plugin.sh ${ONE_UNREAL_TEMPLATE} ${ONE_UNREAL_ENGINE_VERSION} ${ONE_SDK_REPO_DIR} ${ONE_PLUGIN_REPO_DIR} ${ONE_PLUGIN_VERSION}
${ONE_PLUGIN_REPO_DIR}/tools/example_update_client.sh ${ONE_UNREAL_TEMPLATE} ${ONE_UNREAL_ENGINE_VERSION} ${ONE_PLUGIN_REPO_DIR}
${ONE_PLUGIN_REPO_DIR}/tools/example_update_server.sh ${ONE_UNREAL_TEMPLATE} ${ONE_UNREAL_ENGINE_VERSION} ${ONE_PLUGIN_REPO_DIR}
