...
${ONE_PLUGIN_REPO_DIR}/tools/sdk_update_client_plugin.sh ${ONE_UNREAL_MAJOR_VERSION} ${ONE_UNREAL_ENGINE_VERSION} ${ONE_SDK_REPO_DIR} ${ONE_PLUGIN_REPO_DIR}
${ONE_PLUGIN_REPO_DIR}/tools/sdk_update_server_plugin.sh ${ONE_UNREAL_MAJOR_VERSION} ${ONE_UNREAL_ENGINE_VERSION} ${ONE_SDK_REPO_DIR} ${ONE_PLUGIN_REPO_DIR}
