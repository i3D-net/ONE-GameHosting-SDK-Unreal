...
${ONE_PLUGIN_REPO_DIR}/tools/sdk_update.sh ${ONE_UNREAL_ENGINE_VERSION} ${ONE_SDK_REPO_DIR} ${ONE_PLUGIN_REPO_DIR}
${ONE_PLUGIN_REPO_DIR}/tools/example_update.sh ${ONE_UNREAL_ENGINE_VERSION} ${ONE_PLUGIN_REPO_DIR}
