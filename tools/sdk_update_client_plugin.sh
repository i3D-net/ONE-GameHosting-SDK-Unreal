...
ONE_PLUGIN_SOURCE_PRIVATE_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_TEMPLATE}/${ONE_UNREAL_ENGINE_VERSION}/${ONE_PLUGIN_NAME}/Source/${ONE_PLUGIN_NAME}/Private/one/ping
ONE_PLUGIN_SOURCE_PUBLIC_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_TEMPLATE}/${ONE_UNREAL_ENGINE_VERSION}/${ONE_PLUGIN_NAME}/Source/${ONE_PLUGIN_NAME}/Public/one/ping
ONE_PLUGIN_SOURCE_THIRD_PARTY_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_TEMPLATE}/${ONE_UNREAL_ENGINE_VERSION}/${ONE_PLUGIN_NAME}/Source/ThirdParty/one/ping/internal
