...
ONE_EXAMPLE_NAME=PingExample

ONE_TEMPLATE_DIR=${ONE_PLUGIN_REPO_DIR}/template
ONE_TEMPLATE_EXAMPLE_DIR=${ONE_TEMPLATE_DIR}/${ONE_UNREAL_MAJOR_VERSION}/${ONE_EXAMPLE_NAME}

ONE_PLUGIN_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_MAJOR_VERSION}/${ONE_UNREAL_ENGINE_VERSION}/${ONE_PLUGIN_NAME}
ONE_UPLUGIN_FILE=${ONE_PLUGIN_DIR}/${ONE_PLUGIN_NAME}.uplugin

ONE_TARGET_DIR=${ONE_PLUGIN_REPO_DIR}/${ONE_UNREAL_MAJOR_VERSION}/${ONE_UNREAL_ENGINE_VERSION}
