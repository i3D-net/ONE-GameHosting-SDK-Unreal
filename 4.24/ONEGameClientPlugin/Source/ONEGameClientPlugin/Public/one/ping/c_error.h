...
typedef enum I3dPingError {
    ...
    I3D_PING_ERROR_VALIDATION_PING_RESPONSE_COUNT_IS_NULLPTR = 116,
    I3D_PING_ERROR_VALIDATION_RESULT_IS_NULLPTR = 117,
    I3D_PING_ERROR_VALIDATION_IP_LIST_IS_NULLPTR = 118,
    I3D_PING_ERROR_VALIDATION_HTTP_GET_CALLBACK_IS_NULLPTR = 119,
    I3D_PING_ERROR_VALIDATION_SIZE_IS_TOO_SMALL = 120,
    I3D_PING_ERROR_VALIDATION_IP_SIZE_IS_TOO_SMALL = 121,
    ...
    I3D_PING_ERROR_PING_SITE_POS_OUT_OF_RANGE = 305,
    I3D_PING_ERROR_PING_SITE_IP_POS_OUT_OF_RANGE = 306,
    I3D_PING_ERROR_SITE_POS_IS_OUT_OF_RANGE = 400,
    I3D_PING_ERROR_SITE_IP_POS_IS_OUT_OF_RANGE = 401,
    I3D_PING_ERROR_IP_POS_IS_OUT_OF_RANGE = 402,
    ...
    I3D_PING_ERROR_SOCKET_RECEIVE_DESTINATION_UNREACHABLE = 508,
    I3D_PING_ERROR_SOCKET_RECEIVE_UNKNOWN_ICMP_PACKET_TYPE = 509,
    I3D_PING_ERROR_SOCKET_RECEIVE_WRONG_ID = 510,
    ...
    I3D_PING_ERROR_SOCKET_INVALID_SEQUENCE_NUMBER = 518,
    I3D_PING_ERROR_SOCKET_SELECT_FAILED = 519,
    I3D_PING_ERROR_SOCKET_NOT_READY = 520,
    I3D_PING_ERROR_SOCKET_CANNOT_BE_RESET = 521,
    I3D_PING_ERROR_PINGERS_NOT_INITIALIZED = 600,
    I3D_PING_ERROR_PINGERS_ALREADY_INITIALIZED = 601,
    I3D_PING_ERROR_PINGER_DIVISION_BY_ZERO = 602,
    I3D_PING_ERROR_PINGER_INVALID_TIME = 603,
    I3D_PING_ERROR_PINGER_ALREADY_INITIALIZED = 604,
    I3D_PING_ERROR_PINGER_IS_UNINITIALIZED = 605,
    I3D_PING_ERROR_PINGERS_POS_IS_OUT_OF_RANGE = 700,
    I3D_PING_ERROR_IP_LIST_POS_IS_OUT_OF_RANGE = 800,
    I3D_PING_ERROR_IP_LIST_ALLOCATION_FAILED = 801,
} I3dPingError;
