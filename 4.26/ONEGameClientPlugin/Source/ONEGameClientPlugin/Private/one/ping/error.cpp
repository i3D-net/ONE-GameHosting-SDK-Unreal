...
const char *error_text(I3dPingError err) {
    static std::unordered_map<I3dPingError, const char *> lookup = {
        ...
        {I3D_PING_ERROR_SYMBOL_STRING_PAIR(
            I3D_PING_ERROR_VALIDATION_MIN_TIME_IS_NULLPTR)},
        {I3D_PING_ERROR_SYMBOL_STRING_PAIR(I3D_PING_ERROR_VALIDATION_MAX_TIME_NULLPTR)},
        {I3D_PING_ERROR_SYMBOL_STRING_PAIR(
            I3D_PING_ERROR_VALIDATION_MEDIAN_TIME_IS_NULLPTR)},
        {I3D_PING_ERROR_SYMBOL_STRING_PAIR(
