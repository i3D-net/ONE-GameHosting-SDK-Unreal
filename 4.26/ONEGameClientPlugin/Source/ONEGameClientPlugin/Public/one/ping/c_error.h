...
typedef enum I3dPingError {
    ...
    I3D_PING_ERROR_SOCKET_RECEIVE_WRONG_ID = 511,
    I3D_PING_ERROR_SOCKET_RECEIVE_TTL_EXPIRED = 512,
    I3D_PING_ERROR_SOCKET_INVALID_TIME = 513,
    I3D_PING_ERROR_SOCKET_ALREADY_INITIALIZED = 514,
    I3D_PING_ERROR_SOCKET_NOT_INITIALIZED = 515,
    I3D_PING_ERROR_SOCKET_PING_NOT_SENT = 516,
    I3D_PING_ERROR_SOCKET_UNKNOWN_STATUS = 517,
